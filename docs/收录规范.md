...
> [`CONTRIBUTING.md`](https://github.com/HaydenSmith1121/dsh-plugins/blob/main/CONTRIBUTING.md)。
...
[`CONTRIBUTING.md`](https://github.com/HaydenSmith1121/dsh-plugins/blob/main/CONTRIBUTING.md) 第四节。
...
4. 同步检查 [`docs/收录说明.md`](./收录快照说明.md)（面向用户的收录说明）是否需要跟着改
